...
const bestSellerSeeAll = document.getElementById("bestSellerSeeAll");

if (bestSellerSeeAll) {
    bestSellerSeeAll.addEventListener("click", function (e) {
        e.preventDefault();
        ...
        // scroll ke section semua produk
        scrollToProducts();

        // reset tulisan dropdown desktop
        const brandText = document.querySelector("#desktopBrandBtn span");
        if (brandText) brandText.textContent = "Brand";
...
const filterBtn = document.getElementById("desktopFilterBtn");
const filterWrap = document.querySelector(".desktop-filter");
