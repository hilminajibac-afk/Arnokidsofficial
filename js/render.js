...
function render(data){
    ...
    box.innerHTML += createProductCard(p,index);
...
function renderBestSeller(data){
   ...
   data.forEach(p=>{
    ...
    const realIndex = products.findIndex(prod => prod.nama === p.nama);

    console.log(p.nama, realIndex);

    box.innerHTML += `
        <div class="swiper-slide">

           ${createProductCard(p, p.index)}
